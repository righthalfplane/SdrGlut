...
#ifndef AudioFileRA_h
#define AudioFileRA_h
#include "ulibTypes.h"
#include "File8.h"
#include <GL/glui.h>
#include <cstdlib>
...
class AudioFile: public CWindow{
public:
    AudioFile(struct Scene *scene);
    virtual ~AudioFile();
...
typedef AudioFile *AudioFilePtr;

extern AudioFilePtr FindSceneAudioFile(int window);

extern AudioFilePtr FindAudioFileWindow(int window);
