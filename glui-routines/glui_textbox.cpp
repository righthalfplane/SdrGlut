...
int    GLUI_TextBox::mouse_down_handler( int local_x, int local_y )
{
  ...
  if ( debug )    dump( stdout,(char *) "-> MOUSE DOWN" );
  ...
  if ( debug )    dump( stdout,(char *) "<- MOUSE UP" );
                           ...
                           bool new_inside)
{
  ...
  if ( debug )    dump( stdout,(char *) "-> HELD DOWN" );
...
int    GLUI_TextBox::update_substring_bounds( void )
{
  ...
  if ( debug )    dump( stdout,(char *) "-> UPDATE SS" );
...
void    GLUI_TextBox::draw_text( int x, int y )
{
  ...
  if ( debug )    dump( stdout,(char *) "-> DRAW_TEXT" );
...
void     GLUI_TextBox::draw_insertion_pt( void )
{
  ...
  if ( debug )    dump( stdout,(char *) "-> DRAW_INS_PT" );
...
/****************************** GLUI_EditText::append_text() **********/

void    GLUI_TextBox::append_text( const char *new_text )
{
  substring_start = 0;
  text=text+new_text;
  substring_end   = (int) text.length() - 1;
  insertion_pt    = substring_end;
