...
def build_parser():
    ...
    parser.add_argument('--palette', dest='palette', default='default',
        help='Set Color Palette: default, extended, charolastra, twente, rainbow')
    return parser
...
def rainbow_palette():
    pp = [0xFF,0xFF,0xFF,0x00,0x00,0x83,0x00,0x00,0x87,0x00,0x00,0x8B,0x00,0x00,0x8F,0x00,
...
0x00,0x91,0x00,0x00,0x8C,0x00,0x00,0x88,0x00,0x00,0x83,0x00,0x00,0x00,0x00,0x00]
    p=[]
    for i in range(256):
        p.append((pp[i*3],pp[i*3+1],pp[i*3+2]))
    return p
