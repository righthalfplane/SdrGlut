...
This is the Search and Scan release. The last few week have been spent improving the Search and Scan options. See video for details. The Duel Tuner mode works with SDRplay RSPduo and the LimeSDR and it should work with other Soapy duel tuner devices. The transmit mode now works on Windows.  
...
https://github.com/righthalfplane/SdrGlut/releases/tag/v1.18
