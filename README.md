# SdrGult
SdrGlut is a simple software defined radio. Using glut for drawing and glui for its dialogs makes it tiny compared to programs that use QT5 or wxWidgets.
