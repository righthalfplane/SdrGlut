...
This release extends the audio recording capabilities of SdrGlut. It can be programed to record any frequency in any mode at any time. The 48,000 hz 16 bit raw audio files can be imported into Audacity and played or exported as another type of audio file. On MacOS Big Sur, you need to start xquartz before starting SdrGlut. 
