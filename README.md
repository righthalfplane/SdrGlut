...
This is the Improved Scaning release. The last few week have been spent improving the Scan options. See video for details. The Duel Tuner mode works with SDRplay RSPduo and the LimeSDR and it should work with other Soapy duel tuner devices. The transmit mode now works on Windows.  
