...
The Tenth Release is now avaliable. It adds a window that can use the transmit cabable SDRs to send AM, NBFM, USB, and LSB. It has a prebuild exe for macOS, a install package for Windows and a zipped folder to unpack and run from for Ubuntu 18.04.
