del *.o
x86_64-w64-mingw32-gcc -m64 -DGLEW_STATIC -D_WIN32 -DGLUT_NO_LIB_PRAGMA -DGLUT_BUILDING_LIB -D_MSC_VER -c -I./DrawFindPointHistory  -I./mShowOpenGL -I./KdTree-routines -I./glui-routines/include -I./CExpress -I../include ^
...
x86_64-w64-mingw32-g++  -m64  -DGLEW_STATIC -D_WIN32 -DGLUT_NO_LIB_PRAGMA -DGLUT_BUILDING_LIB -c -I./DrawFindPointHistory  -I./mShowOpenGL -I./KdTree-routines -I./glui-routines/include -I./CExpress  -I./Classes -I../include ^
