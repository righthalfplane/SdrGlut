...
int main (int argc, char *argv[])
{
        ...
        strncpy(my_rig->state.rigport.pathname,"/dev/rig",FILPATHLEN - 1);
        strncpy(my_rig->state.rigport.pathname,"/dev/null",FILPATHLEN - 1);

		my_rig->caps->port_type=RIG_PORT_USB;
